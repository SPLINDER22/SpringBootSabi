...
public interface EntrenadorService {
    ...
    List<EntrenadorDTO> buscarEntrenadores(String nombre, String especialidad, Double minPuntuacion, Double maxPuntuacion, Integer minExperiencia, String certificaciones);
